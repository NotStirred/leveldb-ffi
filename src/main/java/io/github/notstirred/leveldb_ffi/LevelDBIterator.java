...
public class LevelDBIterator extends Scoped implements AutoCloseable, Iterator<Map.Entry<byte[], byte[]>> {
    ...
    public boolean valid0() {
        this.alive();
        return leveldb_iter_valid(this.seg) != 0;
    }

    public void seekToFirst0() {
        this.alive();
        leveldb_iter_seek_to_first(this.seg);
    }

    public void seekToLast0() {
        this.alive();
        leveldb_iter_seek_to_last(this.seg);
    }
    ...
    public void seek0(String key) {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            leveldb_iter_seek(this.seg, keySeg, keySeg.byteSize());
        }
    }

    public void next0() {
        this.alive();
        leveldb_iter_next(this.seg);
    }

    public void prev0() {
        this.alive();
        leveldb_iter_prev(this.seg);
    }
    ...
    public byte[] key0() {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment keySeg = leveldb_iter_key(this.seg, sizeSeg);
    ...
    public byte[] value0() {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment sizeSeg = arena.allocate(ValueLayout.ADDRESS);
            MemorySegment keySeg = leveldb_iter_value(this.seg, sizeSeg);
    ...
    public Optional<String> getError() {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            leveldb_iter_get_error(this.seg, errPtr);
